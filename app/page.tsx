  ...
  <a href="/signup" className="rounded-full bg-[#f05a28] px-6 py-3 text-sm font-bold text-white shadow-sm hover:bg-[#d94e20]">Get Started</a>
        ...
        <div className="mx-auto grid min-h-[680px] max-w-7xl items-center gap-12 px-6 py-16 lg:grid-cols-2">
          <div className="relative z-10">
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <a href="/dashboard" className="rounded-full bg-[#f05a28] px-9 py-4 text-center font-bold text-white shadow-sm hover:bg-[#d94e20]">Explore Platform</a>
              <a href="#tools" className="rounded-full border border-[#f05a28] bg-white px-9 py-4 text-center font-bold text-[#f05a28] hover:bg-[#fff4eb]">View Tools</a>
              <a href="https://us06web.zoom.us/j/3155095001" target="_blank" rel="noopener noreferrer" className="rounded-full border border-[#15172f] bg-white px-9 py-4 text-center font-bold text-[#15172f] hover:bg-[#15172f] hover:text-white">Private Room</a>
            </div>
          </div>
      ...
      <section id="features" className="px-6 py-20">
        <div className="mx-auto grid max-w-7xl gap-6 md:grid-cols-3">
          {features.map((feature) => (
            <div key={feature.title} className="rounded-3xl border border-[#eadfd5] bg-white p-8 shadow-sm">
              <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#fff1e7] text-3xl">{feature.icon}</div>
              <p className="mt-8 text-xs font-bold uppercase tracking-[0.35em] text-[#f05a28]">{feature.label}</p>
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-[#15172f]">{feature.title}</h2>
              <div className="mt-5 h-0.5 w-10 bg-[#f05a28]" />
              <p className="mt-5 max-w-sm leading-8 text-slate-600">{feature.text}</p>
      ...
      <section id="about" className="px-6 py-24">
        <div className="mx-auto grid max-w-7xl gap-12 rounded-3xl border border-[#eadfd5] bg-white p-8 shadow-sm md:grid-cols-2 md:p-12">
          <div>
            ...
            <h2 className="text-4xl font-semibold leading-tight tracking-tight text-[#15172f] md:text-5xl">Built around dignity, recovery capital, and real-world support.</h2>
          </div>
      ...
      <section id="tools" className="bg-white px-6 py-24">
        <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2">
          <div>
            ...
            <h2 className="text-4xl font-semibold leading-tight tracking-tight text-[#15172f] md:text-5xl">Practical tools for everyday recovery support.</h2>
          ...
          <div className="grid gap-4">
            {["Personal recovery dashboard","AI reflection assistant","Coaching session notes","Goal setting and reflections","Learning modules","Progress check-ins"].map((tool) => (
              <div key={tool} className="rounded-2xl border border-[#eadfd5] bg-[#fffaf5] p-5 text-slate-700">
      ...
      <section id="contact" className="border-t border-[#eadfd5] bg-white px-6 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h2 className="text-4xl font-semibold tracking-tight text-[#15172f] md:text-5xl">A recovery coaching platform built for real impact.</h2>
