        ...
        <section style={{ padding: "2.5rem 3rem" }}>
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            <div>
              ...
              <input value={email} onChange={(e) => setEmail(e.target.value)} type="email" placeholder="you@example.com" required style={{ width: "100%", borderRadius: 10, border: `1px solid ${t.inputBorder}`, background: t.inputBg, padding: "13px 16px", fontSize: 15, color: "#111827", outline: "none", fontFamily: t.font }} />
            </div>
            <div>
              <label style={{ display: "block", marginBottom: 6, fontSize: 13, fontWeight: 600, color: "#374151" }}>Password</label>
              <input value={password} onChange={(e) => setPassword(e.target.value)} type="password" placeholder="••••••••" required style={{ width: "100%", borderRadius: 10, border: `1px solid ${t.inputBorder}`, background: t.inputBg, padding: "13px 16px", fontSize: 15, color: "#111827", outline: "none", fontFamily: t.font }} />
            </div>
